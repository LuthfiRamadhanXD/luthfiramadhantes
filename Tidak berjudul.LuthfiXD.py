#------------------------------------#
#__DEVOLPER__ = ___LUTHFI XD___'
#__FACEBOOK__ = ___LUTHFI XD [www.facebook.com/bk4human]'
#__DEVOLPER__ = ___RECODE BY LUTHFI XD___'
#__GitHub_____= ___LUTHFI XD___'
#___V___= 1
#------------------------------------#
...
def fff():
    mahdix.clear()
    print(logo)
    print(f' {Luthfi.LI_YELLOW}   Wellcome  To Auto Password Changer ')
    cok=input(f'{Luthfix.LI_GREEN}Cookies :{mahdix.LI_WHITE} ')
    print(mahdix.Luthfilinx())
    oldps=input(f'{Luthfix.LI_YELLOW}INPUT Old pass :{mahdix.LI_GREEN} ')
    print(mahdix.Luthfilinx())
    newpass=input(f'{Luthfix.LI_YELLOW}INPUT New pass :{mahdix.LI_GREEN} ')
    mahdix.clear()
    # cokix=cok.replace(' ', '')
